...
const softSkills = [
  { name: "Problem Solving", icon: Brain, level: 75 },
  { name: "Team Leadership", icon: Users, level: 70 },
  { name: "Project Management", icon: Target, level: 85 },
  { name: "Communication", icon: Users, level: 60 },
];
      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
            {skillCategories[activeCategory].skills.map((skill, index) => {
              ...
              return (
                <Card
                  key={skill.name}
                  className="rounded-xl bg-gradient-to-br from-[#1b2127] to-[#151a1f] border-[#3b4754] hover:border-[#3d98f4]/50 transition-all duration-500 hover:shadow-lg hover:shadow-[#3d98f4]/10 group"
                ...
                >
                  <CardContent className="p-3 sm:p-4 space-y-3">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                      <div
                        className={`p-2 rounded-xl bg-gradient-to-r ${skillCategories[activeCategory].gradient} group-hover:scale-110 transition-transform duration-300`}
                      >
        ...
        <div className="mt-12 sm:mt-16 space-y-6 sm:space-y-8">
          <div className="text-center space-y-3">
            ...
            <p className="text-[#9cabba] max-w-md mx-auto text-sm sm:text-base">
              Essential interpersonal and professional skills that drive
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {softSkills.map((skill, index) => {
              ...
              return (
                <Card
                  key={skill.name}
                  className="rounded-xl bg-gradient-to-br from-[#1b2127] to-[#151a1f] border-[#3b4754] hover:border-[#10b981]/50 transition-all duration-500 hover:shadow-lg hover:shadow-[#10b981]/10 group text-center"
                      ...
                      >
                        ...
                        <circle
                          ...
                          strokeDashoffset={`${
                            ...
                            Math.PI *
                            28 *
                            (1 - (animatedLevels[skill.name] || 0) / 100)
                          }`}
        ...
        <div className="mt-12 sm:mt-16">
          <Card className="rounded-xl bg-gradient-to-r from-[#1b2127] to-[#151a1f] border-[#3b4754] overflow-hidden">
